...
interface LibroDao {
    ...
    @Query("UPDATE table_libro SET titulo_libro=:titulo, descripcion_libro=:descripcion where id_libro=:libroId ")
    fun update(titulo: String, descripcion:String, libroId: Int)
